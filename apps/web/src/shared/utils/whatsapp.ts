import { APP_URL, WHATSAPP_NUMBER } from "@/shared/lib/constants";
import type { CartItem, OrderItem } from "@/shared/types";
...
export function generateCartMessage(items: CartItem[], customer: CustomerDetails): string {
