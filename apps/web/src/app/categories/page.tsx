            ...
            <div className="relative aspect-[3/4] overflow-hidden rounded-none bg-muted">
              ...
              <div className="absolute inset-0 bg-black/30 flex items-end p-4">
                <div className="text-white w-full">
                  <h3 className="font-semibold text-white drop-shadow-sm text-2xl">{cat.name}</h3>
                  {cat.productCount && <p className="text-xs text-white/90 drop-shadow-sm mt-0.5">{cat.productCount} products</p>}
                </div>
              </div>
            </div>
          </Link>
