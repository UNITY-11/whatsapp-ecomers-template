              ...
              <SheetContent side="left" className="w-full max-w-[min(100vw,20rem)] sm:max-w-xs border-r border-border/60 p-4 sm:p-6 overflow-y-auto flex flex-col">
                <div className="flex flex-col gap-6 sm:gap-8 mt-4 sm:mt-8 pb-4 flex-1">
                  ...
                  <nav className="flex flex-col gap-4 sm:gap-5">
                    {NAV_LINKS.map((link) => (
                      <Link
                        ...
                        className="font-heading text-2xl sm:text-3xl font-medium tracking-tight text-primary border-b border-border/60 pb-3 hover:text-accent transition-colors"
                      >
                        {link.label}
                      </Link>
                    ))}
                  ...
                  <div className="mt-auto pt-8 flex items-center gap-5">
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-secondary text-secondary-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Facebook">
                    ...
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-secondary text-secondary-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Instagram">
                    ...
                    <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-secondary text-secondary-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="X (Twitter)">
