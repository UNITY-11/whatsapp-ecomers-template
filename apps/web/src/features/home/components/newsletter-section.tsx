...
export function NewsletterSection() {
 ...
 <div
 className="absolute -right-16 -top-16 h-64 w-64 rounded-global border border-[#B89A5A]/20"
 aria-hidden
 />
 <div
 className="absolute -left-8 bottom-8 h-40 w-40 rounded-global border border-[#F5F0E8]/10"
 aria-hidden
 />
 ...
 <h2 className="font-brand text-brand-h2 sm:text-brand-h1 md:text-[2.75rem] leading-[1.1] text-[#F5F0E8] text-balance max-w-md">
 ...
 <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-global bg-[#F5F0E8]/10 border border-[#B89A5A]/30">
 ...
 <div className="inline-flex items-center justify-center h-12 w-12 rounded-global bg-[#B89A5A]/20 border border-[#B89A5A]/40 mb-4">
 ...
 type="submit"
 disabled={submitted}
 className="w-full h-12 sm:h-[3.25rem] rounded-none bg-[#B89A5A] text-[#1a2e28] hover:bg-[#c9ab6b] font-medium tracking-wide shadow-brand-card"
 >
 {submitted ? (
 <>
