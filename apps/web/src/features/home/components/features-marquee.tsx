...
export function FeaturesMarquee() {
  ...
  return (
    <div className="w-full bg-primary text-primary-foreground overflow-hidden py-3 flex items-center border-t border-primary-foreground/10">
      <div 
      ...
      >
        {duplicatedItems.map((item, i) => (
          <div 
            key={i} 
            className="flex items-center gap-2 px-8 sm:px-12 border-r border-primary-foreground/20 shrink-0"
          >
