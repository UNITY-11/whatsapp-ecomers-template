    ...
    <section className="py-14 sm:py-20 md:py-24 bg-muted/30">
      <Container>
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 sm:mb-12 md:mb-14 gap-4 md:gap-8">
          ...
          <Button variant="outline" className="w-full sm:w-auto shrink-0 rounded-none border-primary text-primary hover:bg-primary/5 hover:text-primary hover:border-primary" asChild>
            <Link href="/products">
              ...
              <Link href={`/products?category=${category.slug.current}`} className="group block">
                <div className="relative aspect-[3/4] overflow-hidden rounded-none bg-muted">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 text-white">
                    <h3 className="font-heading text-sm sm:text-base md:text-lg font-medium tracking-wide leading-tight text-white">{category.name}</h3>
