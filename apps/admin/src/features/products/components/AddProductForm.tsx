        ...
        <div className="rounded-global border-global border-brand-border-global bg-brand-surface p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input type="text" name="name" id="name" required className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input type="text" name="slug" id="slug" required placeholder="e.g. elegant-evening-gown" className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text placeholder:text-brand-text/40 shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <textarea id="description" name="description" rows={5} className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all resize-none"></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-global border-global border-brand-border-global bg-brand-surface p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-8">
            <div>
              ...
              <div className="mt-2">
                <input type="number" step="0.01" name="price" id="price" required className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input type="number" step="0.01" name="salePrice" id="salePrice" className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input type="number" name="stock" id="stock" defaultValue={0} className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-global border-global border-brand-border-global bg-brand-surface p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            ...
            <div>
              ...
              <div className="mt-2">
                <input type="text" name="tags" id="tags" placeholder="e.g. diamond, elegant, 18k gold" className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text placeholder:text-brand-text/40 shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-global border-global border-brand-border-global bg-brand-surface p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input type="text" name="seoTitle" id="seoTitle" className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all" />
              </div>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <textarea id="seoDescription" name="seoDescription" rows={3} className="block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-4 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-inset focus:ring-brand-accent/50 focus:bg-brand-secondary-hover sm:text-brand-body sm:leading-6 transition-all resize-none"></textarea>
              </div>
            </div>
          </div>
        </div>
