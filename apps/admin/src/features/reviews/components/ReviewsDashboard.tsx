...
export default function ReviewsDashboard() {
 ...
 <input type="text"required placeholder="e.g. Jane Doe"className="mt-2 block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-brand-focus-ring focus:bg-brand-secondary-hover sm:text-brand-body transition-all"/>
 </div>
 <div>
 <label className="block text-brand-body font-medium text-brand-text">Rating (1-5)</label>
 <input type="number"min="1"max="5"defaultValue="5"required className="mt-2 block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-brand-focus-ring focus:bg-brand-secondary-hover sm:text-brand-body transition-all"/>
 </div>
 <div>
 <label className="block text-brand-body font-medium text-brand-text">Review Title</label>
 <input type="text"required placeholder="Great product!"className="mt-2 block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-brand-focus-ring focus:bg-brand-secondary-hover sm:text-brand-body transition-all"/>
 </div>
 <div>
 <label className="block text-brand-body font-medium text-brand-text">Comment</label>
 <textarea rows={4} required className="mt-2 block w-full rounded-global border-0 bg-brand-input-bg py-2.5 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-transparent focus:ring-2 focus:ring-brand-focus-ring focus:bg-brand-secondary-hover sm:text-brand-body transition-all resize-none"></textarea>
 </div>
 ...
 return (
 <div className="flex flex-col p-8 max-w-brand mx-auto w-full pb-24 min-h-[calc(100vh-64px)]">
