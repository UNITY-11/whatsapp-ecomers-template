        ...
        <div className="bg-brand-surface border-global border-brand-border-global p-6 shadow-sm mb-4">
          ...
          >
            <div>
              ...
              <input type="text" name="name" required className="mt-1 block w-full rounded-global border-0 bg-white py-2 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-brand-border-global focus:ring-2 focus:ring-brand-accent/50 transition-all" />
            </div>
            <div>
              <label className="block text-brand-body font-medium text-brand-text">Phone Number *</label>
              <input type="tel" name="phone" required placeholder="+1234567890" className="mt-1 block w-full rounded-global border-0 bg-white py-2 px-3 text-brand-text shadow-sm ring-1 ring-inset ring-brand-border-global focus:ring-2 focus:ring-brand-accent/50 transition-all" />
            </div>
