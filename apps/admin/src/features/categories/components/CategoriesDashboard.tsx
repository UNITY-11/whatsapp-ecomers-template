    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-3xl font-bold tracking-tight text-[#1a2e28]">Categories</h1>
          ...
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div className="overflow-hidden shadow-[0_2px_10px_rgb(0,0,0,0.02)] ring-1 ring-[#ddd5c8]/50 sm:rounded-none bg-white">
              <table className="min-w-full divide-y divide-[#ddd5c8]/50">
                <thead>
                  <tr>
                    <th scope="col" className="py-4 pl-4 pr-3 text-left text-[0.65rem] uppercase tracking-[0.2em] font-semibold text-[#1a2e28]/50 sm:pl-6">
                      Name
                    </th>
                    <th scope="col" className="px-3 py-4 text-left text-[0.65rem] uppercase tracking-[0.2em] font-semibold text-[#1a2e28]/50">
                      Slug
                    </th>
                    <th scope="col" className="px-3 py-4 text-left text-[0.65rem] uppercase tracking-[0.2em] font-semibold text-[#1a2e28]/50">
                      Products Count
