...
export default function AddOrderForm() {
 ...
 required
 className="block w-full rounded-global border-0 bg-white py-1.5 px-2 text-brand-body text-brand-text shadow-sm ring-1 ring-inset ring-brand-border-global focus:ring-2 focus:ring-brand-focus-ring"
 />
 </div>
