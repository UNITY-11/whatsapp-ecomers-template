...
export function Sidebar() {
 ...
 key={item.name}
 href={item.href}
 className={`group flex items-center rounded-global px-3 py-2.5 text-brand-body font-medium transition-all hover:translate-x-1 ${
 isActive
 ...
 <button className="group flex w-full items-center rounded-global px-3 py-2.5 text-brand-body font-medium text-brand-text/70 hover:bg-red-50 hover:text-brand-danger transition-all hover:translate-x-1">
 <LogOut className="mr-3 h-5 w-5 shrink-0 text-brand-text/50 group-hover:text-brand-danger transition-colors"/>
 Logout
 </button>
 </div>
 </div>
