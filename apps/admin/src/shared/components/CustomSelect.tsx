...
export default function CustomSelect({
 ...
 className={`w-full flex items-center justify-between rounded-global border-0 py-2.5 px-3 text-left shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-brand-focus-ring transition-all ${
 disabled 
 ...
 <ChevronDown className={`w-4 h-4 transition-transform ${isOpen ?"rotate-180":""} ${disabled ?"text-gray-400":"text-brand-text/50"}`} />
 </button>
