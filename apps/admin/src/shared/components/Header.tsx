...
export function Header() {
 ...
 <input
 id="search-field"
 className="block h-10 w-full rounded-global border-0 bg-brand-input-bg py-0 pl-10 pr-3 text-brand-text placeholder:text-brand-text/50 focus:ring-2 focus:ring-brand-focus-ring focus:bg-brand-secondary-hover transition-all sm:text-brand-body"
 ...
 className="-m-2.5 p-2.5 text-brand-text/70 hover:text-brand-primary transition-colors"
 ...
 <button type="button"className="-m-2.5 p-2.5 text-brand-text/70 hover:text-brand-primary transition-colors">
 ...
 {/* Profile dropdown */}
 <div className="flex items-center gap-x-4 cursor-pointer group hover:bg-brand-secondary-hover p-1.5 rounded-global transition-all">
 <img
 className="h-8 w-8 rounded-global bg-white ring-2 ring-transparent group-hover:ring-brand-accent/50 transition-all"
