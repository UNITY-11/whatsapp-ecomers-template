  ...
  return (
    <div className="flex flex-col gap-8 p-8 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-brand-text/70 mt-2 text-lg">
          Welcome to your custom admin panel.
        </p>
      </div>

      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
        <div className="group rounded-global border border-brand-border bg-brand-surface p-6 transition-all duration-300 hover:bg-brand-secondary-hover hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06),0_0_20px_rgba(15,74,58,0.1)] relative overflow-hidden">
          ...
          <div className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
            <h3 className="tracking-tight text-sm font-medium text-brand-text/70">Total Products</h3>
          </div>
        ...
        <div className="group rounded-global border border-brand-border bg-brand-surface p-6 transition-all duration-300 hover:bg-brand-secondary-hover hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06),0_0_20px_rgba(15,74,58,0.1)] relative overflow-hidden">
          ...
          <div className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
            <h3 className="tracking-tight text-sm font-medium text-brand-text/70">Active Categories</h3>
          </div>
