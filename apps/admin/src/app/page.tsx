export default function AdminDashboard() {
 return (
 <div className="flex flex-col gap-8 p-8 max-w-brand mx-auto">
 <div>
 ...
 <div className="group rounded-global border-global border-brand-border-global bg-brand-surface p-6 transition-all hover:bg-brand-secondary-hover hover:-translate-y-1 hover:shadow-brand-card-hover relative overflow-hidden">
